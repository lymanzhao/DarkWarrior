...
!
function(a) {
    var b = "static/wPaint/plugins/shapes/img/icons-menu-main-shapes.png";
    ...
    a.fn.wPaint.extend({
        ...
        _drawRoundedRectMove: function(a) {
            ...
            this.ctxTemp.roundedRect(a.x, a.y, a.w, a.h, Math.ceil(b * a.w * a.h * .001)),
            this.ctxTemp.stroke(),
            this.ctxTemp.fill()
        },
        ...
        _drawRoundedSquareMove: function(a) {
            this._drawShapeMove(a);
            var b = a.w > a.h ? a.h: a.w;
            this.ctxTemp.roundedRect(a.x, a.y, b, b, Math.ceil(b * b * .001)),
            this.ctxTemp.stroke(),
            this.ctxTemp.fill()
        },
        ...
        _drawDiamondMove: function(a) {
            this._drawShapeMove(a),
            this.ctxTemp.diamond(a.x, a.y, a.w, a.h),
            this.ctxTemp.stroke(),
            this.ctxTemp.fill()
        },
        ...
        _drawCircleMove: function(a) {
            this._drawShapeMove(a);
            var b = a.w > a.h ? a.h: a.w;
            this.ctxTemp.ellipse(a.x, a.y, b, b),
            this.ctxTemp.stroke(),
            this.ctxTemp.fill()
        },
        ...
        _drawPentagonMove: function(a) {
            this._drawShapeMove(a),
            this.ctxTemp.pentagon(a.x, a.y, a.w, a.h),
            this.ctxTemp.stroke(),
            this.ctxTemp.fill()
        },
        ...
        _drawHexagonMove: function(a) {
            this._drawShapeMove(a),
            this.ctxTemp.hexagon(a.x, a.y, a.w, a.h),
            this.ctxTemp.stroke(),
            this.ctxTemp.fill()
        },
