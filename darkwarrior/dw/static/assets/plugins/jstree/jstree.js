		...
		bind : function () {
			...
			this.element
				...
				.on('keypress.jstree', $.proxy(function (e) {
						...
						// match for whole dw2 from current node down (including the current node)
						if(word.length > 1) {
							...
							// match for whole dw2 from the beginning of the tree
						...
						// list nodes that start with that letter (only if dw2 consists of a single char)
