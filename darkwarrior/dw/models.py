...
class File_name(models.Model):
    file_name = models.CharField(max_length=50, blank=True, verbose_name='文件夹名称')
    owner_project = models.CharField(max_length=50, blank=True, verbose_name='所属项目id',default=0)
...
class File_type(models.Model):
    type_name = models.CharField(max_length=50, blank=True, verbose_name='文件夹类型名称')
    owner_project = models.CharField(max_length=50, blank=True, verbose_name='所属项目id',default=0)
    file_name = models.ManyToManyField(File_name,blank=True,verbose_name='文件夹名称')
    def __unicode__(self):
