...
class File_typeAdmin(admin.ModelAdmin):
    list_display = ('id','type_name','owner_project')

class File_nameAdmin(admin.ModelAdmin):
    list_display = ('id','file_name','owner_project')

admin.site.register(File_name,File_nameAdmin)
admin.site.register(File_type,File_typeAdmin)
