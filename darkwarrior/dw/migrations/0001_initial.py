    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date(2016, 12, 12), verbose_name=b'\xe6\x97\xa5\xe6\x9c\x9f')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 600511), verbose_name=b'\xe6\x9b\xb4\xe6\x96\xb0\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner_project', models.CharField(max_length=50, verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe9\xa1\xb9\xe7\x9b\xae')),
                ('create_time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 598843))),
            ],
            options={
                'verbose_name': '\u516c\u53f8\u90e8\u95e8',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('file_name', models.CharField(max_length=50, verbose_name=b'\xe6\x96\x87\xe4\xbb\xb6\xe5\xa4\xb9\xe5\x90\x8d\xe7\xa7\xb0', blank=True)),
                ('owner_project', models.CharField(max_length=50, verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe9\xa1\xb9\xe7\x9b\xaeid', blank=True)),
            ],
            options={
                'verbose_name_plural': '\u6587\u4ef6\u5939\u540d\u79f0',
            },
        ),
        migrations.CreateModel(
            name='File_type',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('type_name', models.CharField(max_length=50, verbose_name=b'\xe6\x96\x87\xe4\xbb\xb6\xe5\xa4\xb9\xe7\xb1\xbb\xe5\x9e\x8b\xe5\x90\x8d\xe7\xa7\xb0', blank=True)),
                ('owner_project', models.CharField(max_length=50, verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe9\xa1\xb9\xe7\x9b\xaeid', blank=True)),
                ('file_name', models.ManyToManyField(to='dw.File_name', verbose_name=b'\xe6\x96\x87\xe4\xbb\xb6\xe5\xa4\xb9\xe5\x90\x8d\xe7\xa7\xb0', blank=True)),
            ],
            options={
                'verbose_name_plural': '\u6587\u4ef6\u5939\u7c7b\u578b',
            },
        ),
        migrations.CreateModel(
            name='Gantt_links',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 601167), verbose_name=b'\xe6\x9b\xb4\xe6\x96\xb0\xe6\x97\xb6\xe9\x97\xb4')),
                ('owner_project', models.CharField(default=0, max_length=20, verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe9\xa1\xb9\xe7\x9b\xae', blank=True)),
            ],
            options={
                'verbose_name': '\u767b\u9646\u9875\u9762\u6807\u9898',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 603799), verbose_name=b'\xe9\xa2\x84\xe6\x9c\x9f\xe5\xae\x8c\xe6\x88\x90\xe6\x97\xb6\xe9\x97\xb4')),
                ...
                ('complete_time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 603856), verbose_name=b'\xe5\xae\x9e\xe9\x99\x85\xe5\xae\x8c\xe6\x88\x90\xe6\x97\xb6\xe9\x97\xb4')),
                ('owner_project', models.CharField(default=0, max_length=20, null=True, verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe9\xa1\xb9\xe7\x9b\xae', blank=True)),
                ('default', models.BooleanField(default=False, verbose_name=b'\xe9\xbb\x98\xe8\xae\xa4\xe9\x80\x89\xe9\xa1\xb9')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 614011), verbose_name=b'\xe9\xa2\x84\xe8\xae\xa1\xe5\xae\x8c\xe6\x88\x90\xe6\x97\xb6\xe9\x97\xb4')),
                ('complete_time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 614036), verbose_name=b'\xe5\xae\x9e\xe9\x99\x85\xe5\xae\x8c\xe6\x88\x90\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 616005))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 635539), verbose_name=b'\xe5\xbc\x80\xe5\xa7\x8b\xe6\x97\xb6\xe9\x97\xb4')),
                ('end_date', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 635564), verbose_name=b'\xe7\xbb\x93\xe6\x9d\x9f\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 619113), verbose_name=b'\xe5\xae\x9e\xe9\x99\x85\xe8\xb5\xb7\xe5\xa7\x8b\xe6\x97\xb6\xe9\x97\xb4')),
                ...
                ('end_date', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 619144), verbose_name=b'\xe5\xae\x9e\xe9\x99\x85\xe7\xbb\x93\xe6\x9d\x9f\xe6\x97\xb6\xe9\x97\xb4')),
                ('predict_start_date', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 619160), verbose_name=b'\xe9\xa2\x84\xe8\xae\xa1\xe8\xb5\xb7\xe5\xa7\x8b\xe6\x97\xb6\xe9\x97\xb4')),
                ...
                ('predict_end_date', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 619183), verbose_name=b'\xe9\xa2\x84\xe8\xae\xa1\xe7\xbb\x93\xe6\x9d\x9f\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 596025), null=True, verbose_name=b'\xe6\x9c\x80\xe5\x90\x8e\xe7\x99\xbb\xe5\xbd\x95\xe6\x97\xb6\xe9\x97\xb4', blank=True)),
                ...
                ('entry_time', models.DateField(default=datetime.date(2016, 12, 12), verbose_name=b'\xe5\x85\xa5\xe8\x81\x8c\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 628663), verbose_name=b'\xe4\xb8\x8a\xe4\xbc\xa0\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 630140), verbose_name=b'\xe4\xb8\x8a\xe4\xbc\xa0\xe6\x97\xb6\xe9\x97\xb4')),
                ('name', models.CharField(max_length=50, verbose_name=b'\xe9\x99\x84\xe4\xbb\xb6\xe5\x90\x8d\xe7\xa7\xb0')),
                ('author', models.ForeignKey(verbose_name=b'\xe4\xb8\x8a\xe4\xbc\xa0\xe8\x80\x85', to='dw.User')),
                ('owner', models.ForeignKey(verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe7\xbb\xb4\xe5\x9f\xba', to='dw.Wiki')),
                ('owner_project', models.ForeignKey(verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe9\xa1\xb9\xe7\x9b\xae', to='dw.Project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2016, 12, 12, 18, 17, 22, 629424), verbose_name=b'\xe4\xb8\x8a\xe4\xbc\xa0\xe6\x97\xb6\xe9\x97\xb4')),
                ('name', models.CharField(max_length=50, verbose_name=b'\xe9\x99\x84\xe4\xbb\xb6\xe5\x90\x8d\xe7\xa7\xb0')),
                ('author', models.ForeignKey(verbose_name=b'\xe4\xb8\x8a\xe4\xbc\xa0\xe8\x80\x85', to='dw.User')),
                ('owner', models.ForeignKey(verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe7\xbb\xb4\xe5\x9f\xba', to='dw.Wiki')),
                ('owner_project', models.ForeignKey(verbose_name=b'\xe6\x89\x80\xe5\xb1\x9e\xe9\xa1\xb9\xe7\x9b\xae', to='dw.Project')),
