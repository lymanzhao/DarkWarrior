...
scheduler.locale = {
    ...
    labels: {
        ...
        icon_delete: "删除",
        confirm_closing: "关闭",
        confirm_deleting: "事件将被永久删除,你确定吗?",
        section_description: "描述",
        section_time: "时间周期",
        full_day: "全天",
        confirm_recurring: "你想编辑重复事件吗?",
    ...
    if (! (e._sday < 0)) {
        ...
        if (s) {
            ...
            if (this._rendered.push(g), s.appendChild(g), h = h + parseInt(s.style.left, 10) + i, this._edit_id == e.id) {
                ...
                v.innerHTML = "<textarea class='dhx_cal_editor' name='text'>" + e.text + "</textarea>",
...
scheduler.form_blocks = {
    ...
    textarea: {
        render: function(e) {
            ...
            return "<div class='dhx_cal_ltext'name='description' style='height:" + t + ";'><textarea></textarea></div>"
        },
...
scheduler.getLightbox = function() {
    if (!this._lightbox) {
        //var e = document.createElement("DIV");  #日历修改创建div
        alert(e)
