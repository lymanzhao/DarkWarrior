...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tFooter = '<div class="file-thumbnail-footer">\n' +
            '<input type="text" class="new_name" old_name="{caption}" value="{caption}" ' +//start
            'style="width:100%;height:25px;border-bottom:1px solid gray;border:none;text-align:center;display:block;" ' +
            ' align="center">'+ //lly 2016/08/31- end
            '    {actions}\n' +
            '</div>',
        ...
        defaultPreviewSettings = {
            ...
            object: {width: "260px", height: "160px"},      //lly
    ...
    FileInput.prototype = {
        ...
        init: function (options) {
            ...
            //alert(self.uploadFileAttr); input标签里name的value
            self.reader = null;
            self.formdata = {};
            self.isIE9 = isIE(9);
            self.isIE10 = isIE(10);
        ...
        getLayoutTemplate: function (t) {
            // t (main1 , caption , preview , footer , progress )
            var self = this,
        ...
        renderFileFooter: function (caption, width) {
            ...
            if (self.isUploadable) {
                //alert(config.indicatorNewTitle);
        ...
        ajaxSubmit: function (fnBefore, fnSuccess, fnComplete, fnError) {
            var self = this, settings;   //ajax 提交 ############################################################################################
            self.uploadExtra();
            settings = $.extend({
                xhr: function () {
        ...
        uploadSingle: function (i, files, allFiles) {
            ...
            updateProgress = function () {
                ...
                self.setProgress(self.uploadPercent);
                self.initPreviewDeletes();
                if(self.uploadCount==total){             //lly 2016/08/31 靠靠
                    
                    $('#update_attachment_name').click();
                      
                };//end
               // location.reload(); //上传进度到百分之百跳转页面
            };
        ...
        previewFile: function (file, theFile, previewId, data) {
            ...
            //alert(this.slug(file.name));   //获取文件名称
            //alert(this.parseFileType(file)); //获取文件类型
            //alert(previewId);//获取文件id
            //alert(file); //文件本事

            //document.getElementById('attachment_name').value = this.slug(file.name);
            //document.getElementById('attachments').value=file;
            //document.getElementById('attachment_type').value=this.parseFileType(file);
            ...
            if (chkTypes && chkMimes) {
                ...
                self.$preview.prepend("\n" + content);           //lly 2016/8/31
        ...
        readFiles: function (files) {
            ...
            $('.new_name').each(function(){                   //lly 2016/08/31 靠靠靠
                var new_name = $(this).attr('old_name');
                for(i=0;i<numFiles;i++){
                     if(self.slug(files[i].name)==new_name){
