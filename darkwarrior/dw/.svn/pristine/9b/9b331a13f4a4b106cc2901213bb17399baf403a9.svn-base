...
(function(g) {
    ...
    if ("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) j = void 0;
        ...
        E = function(a) { (d.setImmediate || d.setTimeout)(function() {
                throw a;
            },
            0)
        },
        ...
        A = function(a, b) {
            ...
            e.readyState = e.INIT;
            b || (b = "download");
            if (D) h = (d.URL || d.webkitURL || d).createObjectURL(a),
            o.href = h,
            o.download = b,
    ...
    B = function(a, b) {
        for (var e = u(b), c = a.buttons.exportData(b.exportOptions), d = b.fieldBoundary, h = b.fieldSeparator, f = RegExp(d, "g"), g = b.escapeChar !== k ? b.escapeChar: "\\", i = function(a) {
            for (var b = "",
            c = 0,
            e = a.length; c < e; c++) 0 < c && (b += h),
    ...
    /*l.ext.buttons.csvHtml5 = {
        ...
        action: function(a, b, d, c) {
            u(c);
            a = B(b, c).str;
            b = c.charset; ! 1 !== b ? (b || (b = f.characterSet || f.charset), b && (b = ";charset=" + b)) : b = "";
            j(new Blob([a], {
                type: "text/csv" + b
            }), t(c))
        },
    ...
    l.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, e, c) {
            ...
            for (var f = 0,
            h = b.body.length; f < h; f++) a += e(b.body[f]);
    ...
    /*l.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, e, c) {
            ...
            b = [];
            c.header && b.push(g.map(a.header,
            function(a) {
                return {
            ...
            for (var f = 0,
            e = a.body.length; f < e; f++) b.push(g.map(a.body[f],
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
            ...
            c.footer && b.push(g.map(a.footer,
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
                    style: "tableFooter"
